...
describe('Script (radiant op codes)', function () {
  ...
  it('should success parse buffer with OP_PUSHINPUTREF OP_REQUIREINPUTREF OP_DISALLOWPUSHINPUTREF OP_DISALLOWPUSHINPUTREFSIBLING and load 36 bytes', function () {
    var buf = Buffer.from(
      [
